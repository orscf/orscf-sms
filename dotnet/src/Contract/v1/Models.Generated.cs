...
namespace MedicalResearch.StudyManagement.Model {
  ...
  [HasLookup("", nameof(OwnerInstituteUid), "", null, nameof(Institute))]
  public class DataEndpoint {

    [Required]
    [Setable(Setability.OnCreation)]
  ...
  public class InstitueRelatedOAuthConfig {
  ...
  [HasLookup("", nameof(InitiatorInstituteUid), "", null, nameof(Institute))]
  ...
  [HasPrincipal("", nameof(RepresentingInstituteUid), "", null, nameof(Institute))]
  ...
  [PropertyGroup(nameof(ResearchStudyUid), nameof(ResearchStudyUid))]
  [HasLookup("", nameof(ResearchStudyUid), "", null, nameof(ResearchStudy))]
  public class Site {
